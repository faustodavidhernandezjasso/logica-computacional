...
\noindent
Calculemos \(np\left(\left(\left(p \lor q\right) \rightarrow r\right) \leftrightarrow \left(\left(\neg r\right) \rightarrow \left(\neg\left(p \lor q\right)\right) \right)\right)\)
\begin{align*}
    np\left(\left(\left(p \lor q\right) \rightarrow r\right) \leftrightarrow \left(\left(\neg r\right) \rightarrow \left(\neg\left(p \lor q\right)\right) \right)\right) &= &\text{Aplicamos }
\end{align*}
\end{document}