...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \item \(\mathcal{I}^{\star}_{1}\left(\varphi \to \psi\right) = 1\) sí y sólo sí \(\mathcal{I}^{\star}_{1}\left( \varphi\right) = 1\) ó \(\mathcal{I}^{\star}_{1}\left( \psi\right) = 1\)
        \item \(\mathcal{I}^{\star}_{2}\left(\varphi \to \psi\right) = 1\) sí y sólo sí \(\mathcal{I}^{\star}_{2}\left( \varphi\right) = 1\) ó \(\mathcal{I}^{\star}_{2}\left( \psi\right) = 1\)
    \end{itemize}
\end{proof}
