...
\begin{enumerate}
% \item $\{p \to q,\; q \to r \to s,\; p \to q \to r \} \models p \to s$
% \item $\{p \to q,\; q\land r  \to s,\; r\} \models p \to s$
 \item $\{p \to q \to r,\; p\lor s,\; t \to q,\;\lnot s \} \models
 \lnot r  \to\lnot t$
%\item $\{t \to p\lor q,\; p \to s\land u,\; q \to \lnot u \} \models
%t  \to s\lor \lnot u $
%  \item $\{(s \to q)  \to s\land r,\;
%   p \to \lnot\big( (r \to\lnot q) \land (p \to r)\big)  \to \lnot q \} \models
%   p\land \lnot s$
%  \item $\{p \to q\lor r,\; \lnot p  \to t,\; (\lnot t\lor s)\land \lnot q \}
%   \models r\lor s$
\end{enumerate}
\subsubsection*{Solución}
Necesitamos tener presente la definición de:
